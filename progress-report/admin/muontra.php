        ...
        <div class="card">
            ...
            <!-- Ô tìm kiếm -->
                        <form method="GET" action="searchs.php" class="d-flex">
                            <input type="text" name="searchs" class="form-control me-2" placeholder="Tìm phiếu mượn...">
                            ...
                            <?php
                                if ($result && $result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        $ngayTra = !empty($row['NgayTra']) ? htmlspecialchars($row['NgayTra']) : '';    
